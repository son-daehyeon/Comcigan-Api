...
public abstract class ComciganBaseApi {
    ...
    public static List<School> searchSchool(String name) {
    ...
    public static Map<Integer, LocalTime> getRange(int code) {
    ...
    public static void main(String[] args) {
        System.out.println(ComciganTeacherApi.getTeacherList(20449));
    }
}
